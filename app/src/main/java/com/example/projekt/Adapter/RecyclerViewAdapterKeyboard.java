...
public class RecyclerViewAdapterKeyboard extends RecyclerView.Adapter<RecyclerViewAdapterKeyboard.ViewHolder> {
    ...
    public RecyclerViewAdapterKeyboard(Context context, List<Integer> imgs, List<String> titles, List<Integer> prices, List<Integer> ids) {
        ...
        holder.checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(holder.checkBox.isChecked()){
                    editor.putString("KEYBOARD", String.valueOf(ids.get(holder.getAdapterPosition())));
                    editor.commit();
